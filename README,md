...
| Задать форму модуляционного напряжения | 0x05 | Код формы сигнала: <br> 1 - симметричная пила <br> 2 - несимметричная пила |
| Задать код амплитуды модуляционного напряжения | 0x06 | Значение кода амплитуды от 1 до 4095 |
| Задать девиацию частоты | 0x07 | TODO |
| Задать крутизну ГУН | 0x08 | TODO |
